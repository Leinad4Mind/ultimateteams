...
(function($) {
	...
	$(function() {
	     ...
	     * the abbreviations)
		 */
		$('#team_type_explain').each(function(){
		 ...
		 */
		$('#team_type_explain').mouseover(function() {

			// first remove all existing abbreviation tooltips
			$('#team_type_explain').next('.tooltip').remove();
		 ...
		 */
		$('#team_type_explain').click(function(){
		 ...
		 */
		$('#team_type_explain').mouseout(function(){
